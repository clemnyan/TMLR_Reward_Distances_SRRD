...
with open(DATA_DIR, "rb") as f:
    mp_diabetes_brain, mp_diabetes_legs, mp_diabetes_resp, mp_diabetes_substance, mp_brain_legs, \
        mp_brain_resp, mp_brain_substance, mp_legs_resp, mp_legs_substance, mp_resp_substance = pickle.load(f)
