...
method = "manual"
grid_size, gamma = 20, 0.1
relationship = "random"



results = []
grid_rewards, s_rewards = cn.fully_connected_mdp(grid_size, relationship)


store_orig, store_epic, store_dard, store_sard, reward_labels = \
    cn.manual_canonicalization(grid_rewards, s_rewards, grid_size, gamma)
...
"""
res_sard = train_network(store_sard, reward_labels)
res_orig = train_network(store_orig, reward_labels)
res_epic = train_network(store_epic, reward_labels)
res_dard = train_network(store_dard, reward_labels)

print("sard = {} and orig = {} and epic = {} and dard = {}".format(res_sard, \
    res_orig, res_epic, res_dard))
results.append([res_sard, res_orig, res_epic, res_dard])
"""
