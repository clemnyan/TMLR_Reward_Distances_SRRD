...
from stable__baselines3.stable__baselines3.common.buffers import ReplayBuffer
from stable__baselines3.stable__baselines3.common.type_aliases import ReplayBufferSamples
