...
import numpy as np
import torch as th
from stable__baselines3.stable__baselines3.common import policies, torch_layers
...
class FeedForward32Policy(policies.ActorCriticPolicy):
    ...
    Note: This differs from stable__baselines3.stable__baselines3 ActorCriticPolicy in two ways: by
...
class SAC1024Policy(sac_policies.SACPolicy):
    ...
    Note: This differs from stable__baselines3.stable__baselines3 SACPolicy by having 1024 hidden units
