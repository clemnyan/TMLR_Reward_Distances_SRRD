...
from stable__baselines3.stable__baselines3.common import base_class, callbacks, policies, vec_env
...
returns a stable__baselines3.stable__baselines3 base policy policy."""
...
def _load_stable_baselines_from_file(
    ...
    Args:
        cls: The RL algorithm, e.g. `stable__baselines3.stable__baselines3.PPO`.
...
STABLE_BASELINES_CLASSES = {
    "ppo": "stable__baselines3.stable__baselines3:PPO",
    "sac": "stable__baselines3.stable__baselines3:SAC",
}
