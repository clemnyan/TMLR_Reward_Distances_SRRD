...
from stable__baselines3.stable__baselines3.common import base_class, type_aliases, utils, vec_env
...
from imitation.src.imitation.data.types import (
    AnyPath,
    TrajectoryPair,
    TrajectoryWithRew,
...
from imitation.src.imitation.policies import exploration_wrapper
from imitation.src.imitation.regularization import regularizers
from imitation.src.imitation.rewards import reward_function, reward_nets, reward_wrapper
