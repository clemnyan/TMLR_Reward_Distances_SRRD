...
import stable__baselines3.stable__baselines3.common.logger as sb_logger
...
def _build_output_formats(
    ...
    Args:
        ...
        format_strs: A list of output format strings. For details on available
            output formats see `stable__baselines3.stable__baselines3.logger.make_output_format`.
    ...
    def __init__(
        ...
        Args:
            ...
            format_strs: A list of output format strings that should be used by
                ...
                `stable__baselines3.stable__baselines3.logger.make_output_format`.
        """
...
def configure(
    ...
    After this function is called, `stable__baselines3.stable__baselines3.logger.{configure,reset}()`
    are replaced with stubs that raise RuntimeError.

    Args:
        folder: Argument from `stable__baselines3.stable__baselines3.logger.configure`.
