stable__baselines3.stable__baselines3"""This ingredient provides a SQIL algorithm instance."""
import sacred
from stable__baselines3.stable__baselines3 import dqn as dqn_algorithm
